    ...
    <div class="auth-page-container">
      <div class="auth-card">
        ...
        <div class="auth-header">
          ...
          <h1>Dealer Account Login</h1>
          <p class="subtitle">Access dealer inventory, submit Platinum projects & manage investor inquiries</p>
        </div>
        ...
        <div *ngIf="activeConflictRole" class="alert-box conflict">
          ...
          <div style="flex: 1;">
            <div><strong>Active {{ activeConflictRole }} Session:</strong> You are already logged in as a {{ activeConflictRole }}. Please logout first before logging in as a Dealer.</div>
        ...
        <form (ngSubmit)="handleLogin()" #loginForm="ngForm" class="auth-form" novalidate>
          ...
          <button type="submit" class="submit-btn" [disabled]="isSubmitting()">
            <span *ngIf="!isSubmitting()">Login to Dealer Portal</span>
        ...
        <div class="auth-footer">
          <p>
            ...
            <a [routerLink]="['/dealer/register']" class="register-link">
              Register as Dealer
            </a>
          </p>
