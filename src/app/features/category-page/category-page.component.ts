...
@Component({
  ...
  template: `
    <div class="category-page-container">
          ...
          <div class="nav-bar-inner">
            ...
            <nav class="breadcrumb-nav" aria-label="Breadcrumb">
              <ol class="breadcrumb-list">
                ...
                <li><span class="crumb-current">{{ currentMeta.title }}</span></li>
              </ol>
            </nav>
          </div>
        </div>
      ...
      <section class="category-hero">
        <div class="container">
          <div class="category-hero-inner">
            <span class="category-eyebrow">VERIFIED PROPERTY PORTFOLIO</span>
            <h1 class="category-title">{{ currentMeta.title }}</h1>
            <p class="category-desc">{{ currentMeta.description }}</p>
            <div class="category-count-pill">{{ currentMeta.count }}</div>
          </div>
        </div>
      </section>

      <!-- Category Quick Switcher Tabs (All 7 Categories) -->
      <section class="cat-switcher-bar">
        <div class="container">
          <div class="switcher-inner">
            <span class="switcher-label">Browse Category:</span>
            <div class="switcher-tabs">
              <button 
                type="button" 
                class="switch-tab" 
                *ngFor="let cat of categoryRoutes" 
                [class.active]="isCurrentSlug(cat.slug)"
      ...
      <!-- Membership Active Banner (if user has active membership) -->
          ...
          <div class="status-banner" [class.gold-status]="plan === 'gold'" [class.plat-status]="plan === 'platinum'">
            <div class="status-left">
              ...
              <span>
                ...
                {{ plan === 'gold' ? 'Gold properties are unlocked. Upgrade to Platinum for VIP trophy estates.' : 'All Gold & Platinum VIP property dossiers, exact prices, addresses and direct contacts are unlocked.' }}
              </span>
            </div>
      ...
      <!-- ============================================================ -->
      <section class="plan-showcase-section gold-showcase-section" id="gold-plan-section">
        <div class="container">
          
          <!-- Gold Plan Header Banner -->
          <div class="plan-section-header gold-header">
            <div class="plan-header-left">
              ...
              <h2 class="plan-section-title gold-title">{{ propertyService.goldPlan().name }} — Verified {{ currentMeta.title }}</h2>
          ...
          <div class="properties-grid" *ngIf="goldProperties.length > 0; else noGoldProps">
            <div class="property-card-wrapper gold-card-border" *ngFor="let prop of goldProperties">
              
              <!-- Property Image (Prominently visible) -->
              <div class="card-media-box">
                <img [src]="prop.imageUrl" [alt]="prop.title" class="prop-img" loading="lazy" />
                
                <div class="media-badges-overlay">
                  <span class="plan-pill-tag gold-pill-tag">GOLD PLAN</span>
                  <span class="type-pill-tag">{{ prop.type | uppercase }}</span>
                </div>

                <div class="verified-indicator" *ngIf="prop.isVerified">
              ...
              <!-- Card Content Area: Unlocked or Locked -->
              <div class="card-body-box">

                <!-- 1. UNLOCKED VIEW (when isGoldUnlocked is true) -->
                <div class="unlocked-details" *ngIf="isGoldUnlocked; else goldLockedTpl">
                  <div class="unlocked-header">
                    ...
                    <span class="access-badge gold-access-badge">
                  ...
                  <div class="specs-pills">
                    ...
                    <span class="pill" *ngIf="prop.specs.roadAccess">{{ prop.specs.roadAccess }}</span>
                  ...
                  <div class="revealed-contact-card">
                    ...
                    <div class="contact-num">
                      ...
                      <span>{{ prop.contactPhone || prop.postedBy?.phone || prop.dealer?.phone || '+1 (555) 019-2834' }}</span>
                    </div>
                  </div>
                ...
                <!-- 2. LOCKED VIEW (Gold Plan Locked Area) -->
          ...
          <ng-template #noGoldProps>
            <div class="empty-plan-card">
              <div class="empty-plan-icon gold-empty-icon">
                <svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor">
                  <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>
                </svg>
              </div>
              <h4 class="empty-plan-title">No {{ propertyService.goldPlan().name }} Properties in {{ currentMeta.title }}</h4>
              <p class="empty-plan-sub">Verified scout-spotted properties and direct listings under {{ propertyService.goldPlan().name }} will appear here once approved.</p>
            </div>
          </ng-template>
      ...
      <!-- ============================================================ -->
      <section class="plan-showcase-section platinum-showcase-section" id="platinum-plan-section">
        <div class="container">
          
          <!-- Platinum Plan Header Banner -->
          <div class="plan-section-header platinum-header">
            <div class="plan-header-left">
              ...
              <h2 class="plan-section-title plat-title">{{ propertyService.platinumPlan().name }} — Luxury & VIP {{ currentMeta.title }}</h2>
              <p class="plan-section-desc">
          ...
          <div class="properties-grid" *ngIf="platinumProperties.length > 0; else noPlatProps">
            <div class="property-card-wrapper plat-card-border" *ngFor="let prop of platinumProperties">
              ...
              <div class="card-media-box">
                ...
                <div class="media-badges-overlay">
                  <span class="plan-pill-tag plat-pill-tag">PLATINUM VIP</span>
                  <span class="type-pill-tag">{{ prop.type | uppercase }}</span>
                </div>

                <div class="verified-indicator plat-verified" *ngIf="prop.isVerified">
                  <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3">
                    <polyline points="20 6 9 17 4 12"></polyline>
                  </svg>
                  <span>VIP DILIGENCE CLEAR</span>
                </div>
              </div>
              ...
              <div class="card-body-box">
                ...
                <!-- 1. UNLOCKED VIEW (when isPlatinumUnlocked is true) -->
                <div class="unlocked-details" *ngIf="isPlatinumUnlocked; else platLockedTpl">
                  <div class="unlocked-header">
                    ...
                    <span class="access-badge plat-access-badge">
                      <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
                        <rect width="18" height="11" x="3" y="11" rx="2" ry="2"></rect>
                        <path d="M7 11V7a5 5 0 0 1 9.9-1"></path>
                      </svg>
                  ...
                  <div class="revealed-contact-card plat-contact-card">
                    <div class="contact-meta">
                      <span class="contact-lbl">Direct Contact / Concierge:</span>
                      <span class="contact-who">{{ prop.postedBy?.name || prop.dealer?.name || 'Verified Partner' }} ({{ prop.postedBy?.role || 'Partner' }})</span>
                    </div>
                    <div class="contact-num plat-contact-num">
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path>
                      </svg>
                      <span>{{ prop.contactPhone || prop.postedBy?.phone || prop.dealer?.phone || '+1 (555) 019-2834' }}</span>
                ...
                <ng-template #platLockedTpl>
                  <div class="clean-locked-card-body plat-locked-theme">
                    ...
                    <span class="locked-tier-pill plat-pill">{{ propertyService.platinumPlan().name }} • ₹{{ propertyService.platinumPlan().price }}/{{ propertyService.platinumPlan().period }}</span>
                  </div>
                </ng-template>
          ...
          <ng-template #noPlatProps>
            <div class="empty-plan-card">
              <div class="empty-plan-icon plat-empty-icon">
                <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                  <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path>
                </svg>
              </div>
              <h4 class="empty-plan-title">No {{ propertyService.platinumPlan().name }} Properties in {{ currentMeta.title }}</h4>
              <p class="empty-plan-sub">Luxury trophy estates and exclusive institutional portfolios under {{ propertyService.platinumPlan().name }} will appear here once approved.</p>
            </div>
          </ng-template>
        ...
        <div class="container">
          <div class="callout-grid-split">
            ...
            <div class="callout-plan-card gold-callout">
              ...
              <ul class="callout-benefit-list">
                <li *ngFor="let b of (propertyService.goldPlan().benefits.length > 0 ? propertyService.goldPlan().benefits.slice(0, 3) : ['Unlock all Gold property prices & exact addresses', 'Direct owner & agent phone numbers', 'Download legal verification reports'])">
                  ✓ {{ b }}
                </li>
              </ul>
            ...
            <div class="callout-plan-card plat-callout">
              ...
              <ul class="callout-benefit-list plat-list">
                <li *ngFor="let b of (propertyService.platinumPlan().benefits.length > 0 ? propertyService.platinumPlan().benefits.slice(0, 3) : ['Unlock ALL Gold & Platinum property dossiers', 'Unlimited direct owner contacts & GPS coordinates', 'Off-market pre-launch inventory & allocations'])">
                  ★ {{ b }}
                </li>
              </ul>
  ...
  styles: [`
    ...
    .property-card-wrapper:hover .prop-img {
    ...
    /* ========================================= */
    /* BOTTOM MEMBERSHIP CALLOUT (TWO OPTIONS)   */
    /* ========================================= */
    ...
    .gold-callout .callout-benefit-list {
      color: var(--slate-700);
    }
